...
/**
 * A simple test webserver: It listens for request at the given port, and for each request,
 * delegates the job of obtaining the appropriate response to the function set via {@link
 * #setResponseSupplier(Function)}.
 */
public class LocalTestServer {
  ...
  public void setResponseSupplier(
      @NonNull Function<FullHttpRequest, FullHttpResponse> responseSupplier) {
              ...
              protected void initChannel(SocketChannel ch) throws Exception {
                ...
                p.addLast(
                    new HttpObjectAggregator(
                        32 * 1024)); // big enough to collect a full thread dump
                p.addLast(
